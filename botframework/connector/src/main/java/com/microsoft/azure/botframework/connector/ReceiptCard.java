...
public class ReceiptCard {
    ...
    /**
     * Array of Fact objects (key-value pairs) that specify information about
     * the purchase.
     */
    ...
    /**
     * A currency-formatted string that specifies the total purchase price,
    ...
    /**
     * A currency-formatted string that specifies the amount of tax applied to
     * the purchase.
     */
    ...
    /**
     * A currency-formatted string that specifies the amount of value added tax
     * (VAT) applied to the purchase price.
     */
